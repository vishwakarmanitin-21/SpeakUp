...
Use `CLAUDE.md` in this repo for project-specific architecture, commands, verification rules, and constraints. The global Codex guidance in `C:\Users\Nitin\.codex\AGENTS.md` also applies.
